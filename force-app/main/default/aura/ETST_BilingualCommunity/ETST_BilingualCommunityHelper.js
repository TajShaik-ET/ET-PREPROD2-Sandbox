({
    setCommunityLanguage : function(component, event, helper) {
        ...
        if(lang == 'ar'){
            ...
            component.set("v.clAddYourBankDetails", $A.get("$Label.c.ETST_Add_Your_Bank_Details_AR"));
            ...
            component.set("v.clRefundAmount", $A.get("$Label.c.ETST_Refund_Amount"));
            ...
            component.set("v.clAddYourBankDetails", $A.get("$Label.c.ETST_Add_Your_Bank_Details"));
            ...
            component.set("v.clIBANcodemuststartwithAE", $A.get("$Label.c.ETST_IBAN_code_must_start_with_AE"));
            ...
            component.set("v.clUploadStudentEmiratesId", $A.get("$Label.c.ETST_Student_emirates_ID"));
