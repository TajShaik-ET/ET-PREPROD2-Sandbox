({
    ...
    doInit : function(component, event, helper) {
        component.set("v.vfUrl",'/apex/ET_ContractCoverMemo?Id='+component.get('v.recordId')); 
    ...
    handleSave : function(component, event, helper){
        ...
        try{
            var action = component.get('c.generateContractMemoDoc');
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") { 
                    ...
                    toastEvent.setParams({
                        "title": "Success!",
                        "type":"success",
                        "message": "The Cover memo document has been Saved successfully."
                    });
                    toastEvent.fire();
