({
    ...
    executeServerCall : function(component, event, helper) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            var uniqueLabel = 'executeServerCall_' + backendMethod + '_' + Date.now();
            console.time(uniqueLabel); // Start the timer with a unique label
            ...
            console.timeEnd(uniqueLabel); // Stop the timer and log the elapsed time   
    ...
    convertToUserFriendlyErrMsg : function (component, event, helper) {
        ...
        }else if (err.includes("INVALID_CROSS_REFERENCE_KEY")) {
            errorToShow = 'There is some error. Please contact Emirates Transport!'; 
        } 
        else { 
            errorToShow = err;
        }
